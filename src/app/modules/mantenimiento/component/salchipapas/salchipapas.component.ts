...
@Component({
  selector: 'app-salchipapas',
  templateUrl: './salchipapas.component.html',
  styleUrls: ['./salchipapas.component.scss']
})
export class SalchipapasComponent implements OnInit {
  ...
  constructor( 
    ...
    )
    {
      this.myFormFilter=this.fb.group({
        categoria: [{value : "salchipapa" , disabled:true}],
    })
    }
